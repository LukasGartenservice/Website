          ...
          <div className="grid lg:grid-cols-5 h-full">
            ...
            >
              ...
              <div className="relative z-20 h-full flex flex-col">
                ...
                <h2 className="text-[2rem] leading-[1.2] md:text-5xl font-serif mb-4 md:mb-6 md:leading-tight">
                  Lassen Sie uns über <br/><span className="text-primary-300 italic font-light drop-shadow-md">Ihren Garten</span> reden.
                </h2>
                <p className="text-primary-100/90 mb-8 md:mb-12 font-sans font-light text-base md:text-lg leading-relaxed max-w-sm">
              ...
              <form className="space-y-4 lg:space-y-10" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                  <div className="space-y-1.5 md:space-y-2 relative group">
                    ...
                    <input 
                      type="text" 
                      id="name" 
                      className="w-full px-4 py-3 md:py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:ring-0 focus:border-primary-500 focus:bg-white transition-all text-slate-800 placeholder-slate-400 font-sans shadow-inner outline-none text-sm md:text-base" 
                ...
                <div className="space-y-1.5 md:space-y-2 relative group">
                  ...
                  <div className="relative">
                    <select 
                      id="service" 
                      className="w-full px-4 py-3 md:py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:ring-0 focus:border-primary-500 focus:bg-white transition-all text-slate-800 appearance-none font-sans text-sm md:text-base outline-none shadow-inner cursor-pointer"
                    >
                ...
                <div className="space-y-1.5 md:space-y-2 relative group">
                  ...
                  <textarea 
                    id="message" 
                    rows="4" 
                    className="w-full px-4 py-3 md:py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:ring-0 focus:border-primary-500 focus:bg-white transition-all text-slate-800 placeholder-slate-400 resize-none font-sans shadow-inner outline-none text-sm md:text-base" 
                ...
                <button 
                  type="submit" 
                  className="bg-primary-600 hover:bg-primary-700 text-white font-bold py-3.5 md:py-4.5 px-10 rounded-full shadow-xl shadow-primary-600/30 transition-all hover:-translate-y-1 inline-flex items-center justify-center gap-3 group mt-2 w-full md:w-auto text-base md:text-lg"
                >
